...
{    
    ...
    // RoutePlanner object below in place of 10, 10, 90, 90.
        ...
        // Initialize the variables with the default values to make the development more convenient
    float start_x = 10.f;
    float start_y = 10.f; 
    float end_x = 90.f; 
    float end_y = 90.f; 
    ...
    std::cout << "Please insert the start and end point cooridnates: " << std::endl; 
    std::cout << "start_x = "; 
    std::cin >> start_x; 
    std::cout << "start_y = "; 
    std::cin >> start_y; 
